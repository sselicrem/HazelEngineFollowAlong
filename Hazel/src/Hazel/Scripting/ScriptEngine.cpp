...
namespace Hazel {
	...
	void ScriptEngine::InitMono()
	{
		...
		mono_runtime_invoke(printMessageFunc, monoClass, nullptr, nullptr);

		MonoMethod* printIntFunc = mono_class_get_method_from_name(monoClass, "PrintInt", 1);
		int value = 5;
		void* param = &value;
		mono_runtime_invoke(printIntFunc, monoClass, &param, nullptr);
		...
		mono_runtime_invoke(printIntsFunc, monoClass, params, nullptr);
